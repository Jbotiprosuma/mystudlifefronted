...
const Header = () => {
  ...
  const isLandingFive = location.pathname === '/index-5' || location.pathname === '/accueil';
...
<>
  ...
  {location.pathname === '/index' || location.pathname === '/index-3' || location.pathname === '/index-4'
      || isLandingFive || location.pathname === '/index-6' ? 
    <></>
  :
  ...
  <header className={`${location.pathname === '/index' ? 'header-one': location.pathname === '/index-3' || location.pathname === '/index-6' ? 
   'header-three':location.pathname === '/index-4' ?'header-four':isLandingFive ?'header-five header-two': 'header-two'} ${scrolled ? "fixed" : ""}`}>
    <div className="container">
      <div className="header-nav">
        <div className="navbar-header">
          ...
          <div className="navbar-logo">
            <Link className="logo-white header-logo" to={isLandingFive ? all_routes.homefive : all_routes.homeone}>
            {isLandingFive ?
                <span className="studlife-brand">Stud’Life</span>
            ...
            <Link className="logo-dark header-logo" to={isLandingFive ? all_routes.homefive : all_routes.homeone}>
              {isLandingFive ? (
                <span className="studlife-brand">Stud’Life</span>
              ) : (
                <ImageWithBasePath
        ...
        <div className={`main-menu-wrapper ${isMegaMenu ? 'active' : ''}`}>
          ...
          <ul className={`main-nav ${isMegaMenu ? 'active' : ''} ${isLandingFive ? 'landing-main-nav' : ''}`}>
            {isLandingFive ? (
              <>
        ...
        {location.pathname === '/index' ?
          ...
          : isLandingFive ?
          <div className="header-btn d-flex align-items-center">
            <Link to={all_routes.login} className="btn btn-white border me-2">
              Connexion
            </Link>
            <Link to={all_routes.register} className="btn btn-primary me-0">
          ...
          <div className="header-btn d-flex align-items-center">
            ...
            <div className="icon-btn me-3">
              <Link to="#" className="bg-white text-primary position-relative">
                <i className="isax isax-shopping-cart5" />
            ...
            <Link to={all_routes.register} className="btn btn-secondary me-0 px-3">
              Register
            </Link>
          </div>
